...
public class QuestionDao {
    ...
    public List<Question> getQuestions(int id) {
        ...
        try {
            ...
            ps = conn.prepareStatement("SELECT qu.Id AS QuestionId, qu.Description AS QuestionDescription FROM test_types AS tt INNER JOIN questions AS qu ON qt.Id=Fk_TestTypeId_Question WHERE qt.Id=?");
            ps.setInt(1,id);
    ...
    public List<Question> getTenRandomQuestions(int id) {
        ...
        try {
            ...
            ps = conn.prepareStatement("" +
                    ...
                    "FROM test_types AS tt INNER JOIN questions AS qu ON tt.Id=Fk_TestTypeId_Question " +
                    "WHERE tt.Id=? " +
